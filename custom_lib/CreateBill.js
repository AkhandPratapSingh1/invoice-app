...
const CreateBill = () => {
  ...
  const [Product, Set_Product] = useState("Product_1");
  ...
  const printToFile = async () => {
    ...
    try{
      ...
      Set_Mobile_No('');
        ...
        Alert.alert("Make shure You have Internet Connection or contact @+91 9759401072");
    }
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            {}
            <Picker.Item label="Product_1" value="Product_1" />
            <Picker.Item label="Product_2" value="Product_2" />
            <Picker.Item label="Product_3" value="Product_3" />
            <Picker.Item label="Product_4" value="Product_4" />
          </Picker>
        </View>
        </View>
        <View style={styles.InputContainer}>
