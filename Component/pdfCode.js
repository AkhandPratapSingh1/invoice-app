...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Akhand Pratap Invoice App<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">Demo Invoice App- A React Native Android App.</div>
    </div>
    ...
    width: 90px;
    margin-right:15px;
        " src="https://i.ibb.co/nLdT74K/Tech.png" />
    </div>
    <hr />
        <hr/>
